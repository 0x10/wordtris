...
public:
    WtMenuCredits() :
        ...
        m_ui_design_header( WtCoord( (ACTIVE_WINDOW_WIDTH / 2) - (m_standard_btn_size.w / 2), offset_y + (offset_content*14)  ),
                      WtDim( m_standard_btn_size.w, 1 ),
                      "#a8a8a8",
                      nullptr,
                      WtL10n_tr("Ui Design"),
                      WtCoord(0, -20) ,
                      WtFont( "#b4b4b4" )),
        m_text_ui_ckr( WtCoord(ACTIVE_WINDOW_WIDTH/2, offset_y + (offset_content*14)+ (1*25+0*10)), WtDim(1,1), "", nullptr, "Christian Kranz"),
        m_text_ui_sdi( WtCoord(ACTIVE_WINDOW_WIDTH/2, offset_y + (offset_content*14)+ (2*25+1*10)), WtDim(1,1), "", nullptr, "Svenja Dittrich"),

        m_font_header( WtCoord( (ACTIVE_WINDOW_WIDTH / 2) - (m_standard_btn_size.w / 2), offset_y + (offset_content*22)  ),
                      WtDim( m_standard_btn_size.w, 1 ),
                      "#a8a8a8",
                      nullptr,
                      WtL10n_tr("Font"),
                      WtCoord(0, -20),
                      WtFont( "#999999" ) ),
        m_text_font_muli0( WtCoord(ACTIVE_WINDOW_WIDTH/2, offset_y + (offset_content*22)+ (1*25+0*10)), WtDim(1,1), "", nullptr, "Muli Font. (c) 2011-2014"),
        m_text_font_muli1( WtCoord(ACTIVE_WINDOW_WIDTH/2, offset_y + (offset_content*22)+ (2*25+0*10)), WtDim(1,1), "", nullptr, "by vernon adams (vern@newtypography.co.uk)"),
        m_text_font_muli2( WtCoord(ACTIVE_WINDOW_WIDTH/2, offset_y + (offset_content*22)+ (3*25+0*10)), WtDim(1,1), "", nullptr, "is licensed under the SIL Open Font License, Version 1.1"),
