...
public:
    WtMenuHighscores() :
        ...
        m_left_btn( WtCoord( (ACTIVE_WINDOW_WIDTH / 8)-(23/2), ((ACTIVE_WINDOW_HEIGHT / 8)+130)-(10) ), 
                    WtDim(23, 42), 
                    "left.bmp",
                    WT_BIND_EVENT_HANDLER( WtMenuHighscores::show_prev_mode ) ),
        m_right_btn( WtCoord( (ACTIVE_WINDOW_WIDTH-(ACTIVE_WINDOW_WIDTH / 8))-(23/2), ((ACTIVE_WINDOW_HEIGHT / 8)+130)-(10) ), 
                     WtDim(23, 42), 
                     "right.bmp",
