...
sdl:
	$(CXX) $(CXX_OPTIMIZATION) $(CXX_FLAGS) $(LD_FLAGS) -I./pc_include -I$(BUILD_DIR) -I$(SRC_DIR) $(SRC_DIR)/wordtris.cpp -L$(SDL_DIR)/build/.libs -lSDL2 -o $(TARGET_SDL)

sdl-system:
	$(CXX) $(CXX_OPTIMIZATION) $(CXX_FLAGS) $(LD_FLAGS) -DUSE_SYSTEM_SDL -I./pc_include -I$(SRC_DIR) $(SRC_DIR)/wordtris.cpp -lSDL2 -o $(TARGET_SDL)
